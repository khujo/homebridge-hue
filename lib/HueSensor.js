  ...
  switch (this.obj.type) {
    ...
    case 'ZHASwitch':
      if (
        ...
        //this.createButton(2, 'Dim Up', SINGLE_LONG)
        this.createButton(3, 'Button 1', SINGLE_LONG)
        this.createButton(4, 'Button 2', SINGLE_LONG)
        this.createButton(5, 'Button 3', SINGLE_LONG)
        this.createButton(6, 'Button 4', SINGLE_LONG)
        this.type = {
          key: 'buttonevent',
          homekitValue: function (v) { return Math.floor(v / 1000) },
          homekitAction: hkZLLSwitchAction
